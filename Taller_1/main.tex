...
\bibitem{Sadiku} Sadiku, M. N. O. (2014). \textit{Elements of Electromagnetics} (6th ed.). Oxford University Press.
  
\bibitem{SchaumEM} Edminister, J. A. (1995). \textit{Schaum's Outline of Electromagnetics} (2nd ed.). McGraw-Hill.
  
\bibitem{EquipotentialLab} MIT OpenCourseWare. (s.f.). \textit{Equipotential Lines and Electric Fields Lab}. Disponible en línea.
